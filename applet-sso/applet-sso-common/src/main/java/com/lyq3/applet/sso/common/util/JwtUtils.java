...
public class JwtUtils {
     ...
     * JWT 生成密钥使用的密码
     */
    private static final String JWT_RULE = "kalubi";
     ...
     * @return
     */
    public static String decrypt(String claimsJws) {
        Claims claims = null;
        try {
            SecretKey key = generateKey(JWT_ALG, JWT_RULE);
            // 获取 JWT 的 payload 部分
            claims = parseJWT(key, claimsJws).getBody();
        } catch (Exception e) {
